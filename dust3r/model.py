...
#             if self.GS:
#                 res1_GS = self._downstream_head_GS(1, ([tok.float() for tok in dec1[-1:]], view1_img), shape1)
#                 res2s_GS = [self._downstream_head_GS(2, ([tok.float() for tok in dec2[-1:]], view2_img), shape2) for (dec2, shape2, view2_img) in zip(dec2s, shape2s, view2s_img)]
#                 res1 = {**res1, **res1_GS}
#                 res2s_new = []

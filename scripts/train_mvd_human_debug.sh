...
--test_dataset " \
MVDataset(n_all=5, split='test', ROOT='trajectories/habitatSim_test', resolution=(512,384), seed=777, fix_order=True, num_views=10, num_render_views=6, render_start = 4, dps_name = 'dps_test.h5', tb_name = 'hs_tdf_2_testFull_30_6', n_ref = 4)" \
...
--output_dir outputs/MVD_human_512_debug
